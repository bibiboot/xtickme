    ...
    function bend2() {
    	...
    	rotate_body(1, cx, cy, bendDirection, body1);
    	rotate_lhand(1, cx, cy, bendDirection, lhand1);
    	rotate_rhand(1, cx, cy, bendDirection, rhand1);
    	rotate_head(1, cx, cy, bendDirection, head1);
    ...
    function fly2() {
    	...
    	rotate_lhand(1, 0, 75, flyDirection, lhand1);
    	rotate_rhand(1, 0, 75, -flyDirection, rhand1);
    ...
    function thigh_split2() {
        ...
        var cx = lthigh1.x.baseVal.value;
        var cy = lthigh1.y. baseVal.value;
        rotate_lthigh(1, cx, cy, flyDirection, lthigh1);
        rotate_rthigh(-1, cx, cy, flyDirection, rthigh1);
    ...
    function jump2(){
        ...
        //jump up
         if(jump_inc<20){
                 jump_inc++;
                 velocity=400;
                 move_body_v(body1, head1, lhand1, rhand1, lthigh1, rthigh1);
    ...
    function shocked2(){
        ...
        move_body_h(head1, body1, lhand1, rhand1, lthigh1, rthigh1);
        move_body_v(body1, head1, lhand1, rhand1, lthigh1, rthigh1); 
        i++;
    ...
    function shake2() {
        if(i<20){
            ...
            move_body_h(head1, body1, lhand, rhand, lthigh1, rthigh1);
            i++;
        } else {
            i=0;
            velocity=-velocity;
